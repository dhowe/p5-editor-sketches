...
let pg,
  firstLoop = false;
let paused = false;
let mouseSetX, mouseSetY;

// next: white dust on black pixels ?
// only color on closed curves
// option to force-close a curve
// check/display percent black
// click to start next curve at pos
...
function curvedLine() {
  ...
  for (let i = 0; i < steps; i++) {
    ...
    while (d > maxPointDist || d < minPointDist) {
