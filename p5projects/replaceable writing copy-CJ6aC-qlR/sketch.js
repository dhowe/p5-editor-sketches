...
// text courtesy of https://brainly.ph/question/5589365
...
function nextWord() {
  ...
  for (let i = r; i < words.length + r; i++) {
    ...
    let rhymes = RiTa.rhymesSync(word, { pos });
    let sounds = RiTa.soundsLikeSync(word, { pos });
    let spells = RiTa.spellsLikeSync(word, { pos });
